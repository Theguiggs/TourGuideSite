...
Status: implemented — les six LW sont réalisées localement. Restent l’acceptation LW-5 après déploiement public et les essais Android/iOS physiques, dont écran verrouillé (LW-2). Aucun push effectué.
