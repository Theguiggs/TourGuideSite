...
export default defineConfig({
  testDir: './e2e/tests',
  testIgnore: ['**/pwa.spec.ts', '**/visitor-auth.spec.ts', '**/visitor-home.spec.ts', '**/visitor-experience.spec.ts', '**/seo-multilingue.spec.ts'], // Passes de production locale séparées.
  fullyParallel: false,
