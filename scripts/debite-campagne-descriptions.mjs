...
const USAGE = {
  input_tokens: 4_694_176 + 6_141 + 2_456,
  output_tokens: 43_116 + 45 + 80,
...
const crochet = egress.crochetDeTraduction({
  enveloppe: 'interne',
  rattachement: ledger.rattachementInterne('campagne-descriptions-poi', 'multi'),
  decouvert: false,
  texte: 'x'.repeat(99_566),
});
