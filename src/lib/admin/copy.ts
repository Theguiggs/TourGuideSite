...
Accès gratuit au lancement|Free access at launch|Acceso gratuito al lanzamiento|Kostenloser Zugang zum Start|Accesso gratuito al lancio|Gratis toegang bij lancering
...
Accès actuel : {0}.|Current access: {0}.|Acceso actual: {0}.|Aktueller Zugang: {0}.|Accesso attuale: {0}.|Huidige toegang: {0}.
