...
export function OnboardingBubble({ feature, title, description, position = 'bottom' }: OnboardingBubbleProps) {
  ...
  return (
    <div
      className={`relative bg-grenadine text-white rounded-lg p-3 shadow-lg max-w-sm ${
    ...
    >
      ...
      <div className="flex gap-2 mt-2 justify-end">
        <button
          ...
          className="text-meta text-grenadine-soft hover:text-white px-2 py-0.5 rounded"
        ...
        <button
          onClick={dismissAll}
          className="text-meta text-grenadine-soft hover:text-white underline"
